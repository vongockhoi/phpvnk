...
class CancelReservationJobForApp implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($device_token) {
            $title = "Reservation cancelled #{$this->reservation->id}";
            $sub_title = "Một đơn đặt bàn vừa hủy #{$this->reservation->id}";
            $content_body = null;
