...
class CreateReservationJobForWeb implements ShouldQueue
{
    ...
    public function handle()
    {
        $firebaseToken = Device::whereHas('user', function($q) {
            ...
            $q->whereHas('restaurants', function($e) {
                $e->where('restaurants.id', $this->reservation->restaurant_id);
            });
        ...
        $data = [
            ...
            "notification"     => [
                ...
                "body"  => "Bạn vừa có 1 đơn đặt bàn mới #{$this->reservation->id}",
            ],
            "data"             => [
                "orderUrl"         => "https://admin.norifood.vn/admin/reservations/{$this->reservation->id}/edit",
                "status"           => ReservationConstant::STATUS['WAIT_CONFIRM'],
