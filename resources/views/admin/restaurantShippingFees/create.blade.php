...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.restaurantShippingFee.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.restaurant-shipping-fees.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_fee') ? 'is-invalid' : '' }}" type="number" name="shipping_fee" id="shipping_fee" value="{{ old('shipping_fee', '') }}" step="0.01" required>
