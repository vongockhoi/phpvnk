...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.cart.cart_list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-customerCarts">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-customerCarts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
