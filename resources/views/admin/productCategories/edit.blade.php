    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $productCategory->description) }}">
            ...
            <div class="form-group">
                <label class="required" for="icon">{{ trans('cruds.productCategory.fields.icon') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.productCategory.fields.icon_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="avatar">{{ trans('cruds.productCategory.fields.avatar') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.productCategory.fields.avatar_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    Dropzone.options.iconDropzone = {
        ...
        init: function () {
            ...
            var file = {!! json_encode($productCategory->icon) !!}
...
<script>
    ...
    init: function () {
@if(isset($productCategory) && $productCategory->avatar)
      var file = {!! json_encode($productCategory->avatar) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview)
      file.previewElement.classList.add('dz-complete')
