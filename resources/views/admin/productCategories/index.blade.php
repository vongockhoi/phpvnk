...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.productCategory.product_category_list') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ProductCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.productCategory.fields.icon') }}
                        </th>
                        <th>
                            {{ trans('cruds.productCategory.fields.avatar') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                        ...
                        <tr data-entry-id="{{ $productCategory->id }}">
                            ...
                            <td>
                                @if($productCategory->icon)
                                    <a href="{{ $productCategory->icon->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $productCategory->icon->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
                                @if($productCategory->avatar)
                                    <a href="{{ $productCategory->avatar->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $productCategory->avatar->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
