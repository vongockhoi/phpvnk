...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.operatingTime.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.operating-times.update", [$operatingTime->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('restaurant') ? 'is-invalid' : '' }}" name="restaurant_id" id="restaurant_id" required>
                    @foreach($restaurants as $id => $entry)
                        <option value="{{ $id }}" {{ (old('restaurant_id') ? old('restaurant_id') : $operatingTime->restaurant->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('open_time') ? 'is-invalid' : '' }}" type="text" name="open_time" id="open_time" value="{{ old('open_time', $operatingTime->open_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('close_time') ? 'is-invalid' : '' }}" type="text" name="close_time" id="close_time" value="{{ old('close_time', $operatingTime->close_time) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('monday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="monday" id="monday" value="1" {{ $operatingTime->monday || old('monday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tuesday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tuesday" id="tuesday" value="1" {{ $operatingTime->tuesday || old('tuesday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('wednesday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="wednesday" id="wednesday" value="1" {{ $operatingTime->wednesday || old('wednesday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('thursday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="thursday" id="thursday" value="1" {{ $operatingTime->thursday || old('thursday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('friday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="friday" id="friday" value="1" {{ $operatingTime->friday || old('friday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('saturday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="saturday" id="saturday" value="1" {{ $operatingTime->saturday || old('saturday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sunday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sunday" id="sunday" value="1" {{ $operatingTime->sunday || old('sunday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('day_off') ? 'is-invalid' : '' }}" type="text" name="day_off" id="day_off" value="{{ old('day_off', $operatingTime->day_off) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time_off') ? 'is-invalid' : '' }}" type="text" name="time_off" id="time_off" value="{{ old('time_off', $operatingTime->time_off) }}">
