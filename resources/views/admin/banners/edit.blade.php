...
{{--            </div>--}}
            <div class="form-group">
                <label class="required" for="avatar">{{ trans('cruds.banner.fields.avatar') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.banner.fields.avatar_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    init: function () {
@if(isset($banner) && $banner->avatar)
      var file = {!! json_encode($banner->avatar) !!}
