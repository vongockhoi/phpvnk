...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-reservationOrders">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.order.fields.reservation') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-reservationOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
